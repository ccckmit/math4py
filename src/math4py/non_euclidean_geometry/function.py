...
def spherical_triangle_area(p1, p2, p3):
    ...
    # 計算球面三角形的內角
    a = spherical_distance(SphericalPoint.from_cartesian(cart2), 
                          SphericalPoint.from_cartesian(cart3))
    b = spherical_distance(SphericalPoint.from_cartesian(cart1), 
                          SphericalPoint.from_cartesian(cart3))
    c = spherical_distance(SphericalPoint.from_cartesian(cart1), 
                          SphericalPoint.from_cartesian(cart2))

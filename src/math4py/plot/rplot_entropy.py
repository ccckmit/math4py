...
def plot_entropy(
    p, base=2, main="Entropy", xlab="Outcome", ylab="Probability", col="skyblue", **kwargs
):
    """繪製熵長條圖。
...
def plot_kl(
    ...
    **kwargs,
    ...
    ax.text(0.5, 0.95, f"D_KL(P||Q) = {kl:.4f}", transform=ax.transAxes, ha="center", fontsize=12)

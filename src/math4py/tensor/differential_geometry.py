...
def christoffel(g: Tensor, coord: Optional[Tensor] = None) -> Tensor:
            ...
            for nu in range(n):
                ...
                for sigma in range(n):
                    if coord is not None:
                        term1 = (coord.data[nu] - coord.data[sigma]) * g_data[sigma, rho]
                        term2 = (coord.data[mu] - coord.data[sigma]) * g_data[sigma, rho]
                        term3 = (coord.data[sigma] - coord.data[mu]) * g_data[mu, nu]
                    else:
                        term1 = g_data[nu, sigma]
                        term2 = g_data[sigma, mu]
                        term3 = g_data[mu, nu]

...
class TestEulerCharacteristicTheorem:
    ...
    def test_torus(self):
        ...
        # 简体：使用正确的欧拉示性数
        topt.euler_characteristic_theorem(0, 0, 1, genus=1)
...
class TestUreyLefschetzFixedPoint:
    def test_sphere_map(self):
        ...
        # 简化：勒夫谢茨数 = 欧拉示性数 = 2
        # 不动点数应该 >= |χ| = 2
        fixed_pts = [{"x": 0.0, "y": 0.0, "z": 1.0}, {"x": 0.0, "y": 0.0, "z": -1.0}]  # 2个不动点
